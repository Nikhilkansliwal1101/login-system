...
if (isset($_POST["submit"])) {
    ...
    $query = "INSERT INTO `user` (`userid`, `name`, `email`, `password`, `mobile`, `address`, `city`, `state`, `pincode`, `date`) VALUES (NULL,'$name', '$email','$hash', '$mobile', '$address', '$city', '$state', '$pincode', current_timestamp());";
...
if (isset($_POST['sendotp'])) {
    ...
    if ($num == 0) {
        ...
        exec("python sendotp.py $email $subject", $output, $r);
            ...
            <form class="row g-3" method="post" action="signin.php">
                ...
                <div class="col-md-4">
                    ...
                    <select id="inputState" class="form-select" name="state">
                        ...
                        <option selected value="Hariyana">Hariyana</option>
                        <option selected value="Gujrat">Gujrat</option>
                    </select>
                </div>
                <div class="col-12">
